...
from src.retriever import build_retriever, load_embeddings_and_index, build_bm25_retriever
...
model, index, documents = build_retriever(documents)
...
evaluation_results = evaluate_model(validation_dataset, model, generation_model, index, bm25, documents, api_key)
